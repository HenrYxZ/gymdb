...
<form method="POST" action="index.php?cat=socios&action=quitarsocio" >
...
?>
	...
	<tr>
        ...
        <td><input type="checkbox" name="eliminados[]" value="<?php echo $socio['rut_socio']?>"/></td>
	</tr>
...
<input type="submit" value="Eliminar"/> <input type="reset" />
</form>
