	...
	try{
		...
		*/
		...
		<form action="index.php" method="get" class="selectUser">
			<h2>Escoger un recepcionista</h2>
			...
			<label for="recepcionistaId">Recepcionista:</label>
			<select name="recepcionistaId" id="recepcionistaId">
				<option value="">--- Elegir ---</option>
				<?php
				foreach($dbh->query($q) as $row){
				?>
					<option value="<?php echo htmlspecialchars($row['rut_recepcionista']); ?>">
						<?php
