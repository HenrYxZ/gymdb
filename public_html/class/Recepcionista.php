<?php
	class Recepcionista implements iUser
	{
			...
			if($rut !== '')
			{
				...
				try{
					...
					*/
					...
					// Bind the parameters
					$stmt->bindParam(':rut_recepcionista', $rut, PDO::PARAM_STR);
					...
					// Assign values
					$this->rut = $result['rut_recepcionista'];
		...
		public function insert()
		{
			if ( !in_array(null, $this->getNotNullClassVarsValues(), true) )
			{
				try{
					...
					// Bind the parameters
					$stmt->bindParam(':rut_recepcionista', $this->rut, PDO::PARAM_STR);
